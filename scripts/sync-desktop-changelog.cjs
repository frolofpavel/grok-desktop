...
const ENTRIES = [
  ...
  },
  {
    ...
    changes: [
      ...
      'Скрипт scripts/sync-cli-brain.ps1 и npm run sync:cli-brain — подтягивание скиллов из ~/.grok.',
...
async function main() {
  ...
  const children = [
    ...
    body('Исходники: C:\\Users\\RAYNER\\grok-desktop'),
